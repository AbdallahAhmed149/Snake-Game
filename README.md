...
- **Snake Movement** 🕹️: Control the snake using arrow keys (Up, Down, Left, Right) to navigate the game area.
...
- The snake moves continuously, updating every 0.1 seconds ⏱️.
